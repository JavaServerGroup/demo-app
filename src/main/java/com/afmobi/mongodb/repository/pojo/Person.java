package com.afmobi.mongodb.repository.pojo;
	...
	*/
	...
	public String toString() {
		return "Person [firstname=" + firstname + ", lastname=" + lastname + ", email=" + email + ", age=" + age
				+ ", sex=" + sex + ", createdAt=" + createdAt + ", skills=" + skills + ", location=" + location
				+ ", address=" + address + ", shippingAddresses=" + shippingAddresses + ", creator=" + creator
				+ ", coworker=" + coworker + ", fans=" + fans + ", realFans=" + realFans + ", credentials="
				+ credentials + "]";
	}
